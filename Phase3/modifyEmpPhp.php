...
$reg = "select FName, LName, Title, PhoneNum, Email, Street, City, State, Zipcode, Gender, DOB, Salary, Password from Employee where EmployeeID = '$username'";
...
<h3>Postition Information</h3>

<p>	Title &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="title" value="<?php echo $row['Title']; ?>"></input>
</p>

<p>	Salary &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="salary" value="<?php echo $row['Salary']; ?>"></input>
</p>
